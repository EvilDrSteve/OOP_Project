...
/**
 * @brief Non-player cook rendered in the kitchen area; walks between counter and
 *        stove in a small state machine (IdleAtCounter -> WalkingToStove ->
 *        CookingAtStove -> ReturningToCounter) to animate order preparation.
 *
 * Purely decorative relative to the Kitchen / Order pipeline: actual order
 * status transitions live in Kitchen and Order.
 */
