...
/**
 * @brief Two-slot carry inventory for the Player. Each slot holds an Item
 *        which pairs an ItemType (ORDER, FOOD, DIRTY_DISHES) with the
 *        Table/Customer/orderId context the Grid needs to route interactions.
 *
 * Fully inline; no matching .cpp.
 */
class Inventory {
private:
