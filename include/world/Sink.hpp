...
/**
 * @brief Wash station where the Player drops DIRTY_DISHES items picked up from
 *        dirty Tables. Keeps a counter of dishes washed and runs a small
 *        animation while in use.
 */
class Sink {
private:
